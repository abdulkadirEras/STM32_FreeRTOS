...
/* Definitions for PotGorev */
osThreadId_t PotGorevHandle;
const osThreadAttr_t PotGorev_attributes = {
  .name = "PotGorev",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for LEDParlakGorev */
osThreadId_t LEDParlakGorevHandle;
const osThreadAttr_t LEDParlakGorev_attributes = {
  .name = "LEDParlakGorev",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_PotGorevFonksiyonu */
/**
  * @brief  Function implementing the PotGorev thread.
...
/* USER CODE BEGIN Header_LEDParlakGorevFonksiyon */
/**
* @brief Function implementing the LEDParlakGorev thread.
* @param argument: Not used
* @retval None
*/
